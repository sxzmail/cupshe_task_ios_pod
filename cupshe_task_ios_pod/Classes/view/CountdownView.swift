...
//    private var countDownSecbase: Int = 5
    ...
    private var notifyCallback: ((String) -> Void)?
...
//        self.regularPath = fontManager.getrRegularFontPath(for: TaskListView.self)
    ...
    public func showView(uiViewController: UIView,token:String,brand:String,channel:String,site:String,terminal:String,lang: String,data:TaskPageViewVO,env:TaskEnvironment,activityId:String,notifyCallbacdk:((String) -> Void)?){
        ...
        self.notifyCallback = notifyCallbacdk
//        self.countDownSec = self.taskPageViewData!.targetValue
